    ...
    setOtpData({ ...otpData, [name]: value });
          ...
          if(!sent)
        {
          const sendOTP = async () => {
            try {
              console.log(umail);
              const response = await axios.post(`https://fruitsbe.onrender.com/u/${umail}`);
        ...
        verify();
          ...
          if (!name || !umail || !password || !phone || !address) {
            ...
            toast.error("Please enter a vaild email");
              ...
              try {
                const response = await axios.post("https://fruitsbe.onrender.com/u/user/insertion", requestData);
