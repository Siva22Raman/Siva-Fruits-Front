...
const ShoppingCart = () => {
  ...
  const handleopenpay=(data)=>{
    const options={
      ...
      "handler": function (response){
        ...
        axios.post(`https://fruitsbe.onrender.com/verify`,{response:response}).then((res)=>{
          toast.success("order completed");
           axios
        .post(`https://fruitsbe.onrender.com/b/product/cart/${u.uid}`, cart.Cartitems) // Sending the array directly
        .then((response) => {
  ...
  const handleBuyClick = (us) => {
    ...
    axios.post(`https://fruitsbe.onrender.com/orders`,_data).then((res)=>{
      if(res){
