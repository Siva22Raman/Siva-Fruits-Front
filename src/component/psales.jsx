...
const Ps = () => {
  ...
  const hao = (product) => {
    ...
    if (confirmed) {
      ...
      axios
        .delete(`https://fruitsbe.onrender.com/p/product/de/${product._id}`)
        .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`https://fruitsbe.onrender.com/p/product/usp/${us.uid}`)
        ...
        {users.map((product) => (
          <div className="cart-item" key={product._id}>
            ...
            <div className="cart-product-quantity">
              <button className='btn' onClick={() => hao(product)}>Remove</button>
            </div>
